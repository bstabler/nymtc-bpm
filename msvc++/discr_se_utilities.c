/*
 *	Discretionary journey mode choice socioeconomic related components of systematic utilites for each modal alternative
 *
...
float discr_sr2_se_util (struct socec_data *SocecData)
{
...
float discr_sr3_se_util (struct socec_data *SocecData)
{
...
float discr_sr4_se_util (struct socec_data *SocecData)
{
...
float discr_wt_se_util (struct socec_data *SocecData)
{
...
float discr_dt_se_util (struct socec_data *SocecData)
{
...
float discr_wc_se_util (struct socec_data *SocecData)
{
...
float discr_dc_se_util (struct socec_data *SocecData)
{
...
float discr_tx_se_util (struct socec_data *SocecData)
{
