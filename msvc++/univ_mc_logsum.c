...
// and calculate the next highest level (1 level higher than lowest) utilties
	...
	if (Avail[0]) {
		...
		if (da < -MAX_EXP || da > MAX_EXP) {
			printf ("\nerror in univ_mc_logsum() calculating da for journey #%d\n", journey);
	...
	if (Avail[8]) {
		...
		if (tx < -MAX_EXP || tx > MAX_EXP) {
			printf ( "\nerror in univ_mc_logsum() calculating tx for journey #%d\n", journey);
	...
	if (Avail[1]) {
		...
		if (sr2 < -MAX_EXP || sr2 > MAX_EXP) {
			printf ( "\nerror in univ_mc_logsum() calculating sr2 for journey #%d\n", journey);
	...
	if (Avail[2]) {
		...
		if (sr3 < -MAX_EXP || sr3 > MAX_EXP) {
			printf ( "\nerror in univ_mc_logsum() calculating sr3 for journey #%d\n", journey);
	...
	if (Avail[3]) {
		...
		if (sr4 < -MAX_EXP || sr4 > MAX_EXP) {
			printf ( "\nerror in univ_mc_logsum() calculating sr4 for journey #%d\n", journey);
	...
	if (Avail[4]) {
		...
		if (wt < -MAX_EXP || wt > MAX_EXP) {
			printf ("\nerror in univ_mc_logsum() calculating wt for journey #%d\n", journey);
	...
	if (Avail[5]) {
		...
		if (dt < -MAX_EXP || dt > MAX_EXP) {
			printf ("\nerror in univ_mc_logsum() calculating dt for journey #%d\n", journey);
	...
	if (Avail[6]) {
		...
		if (wc < -MAX_EXP || wc > MAX_EXP) {
			printf ("\nerror in univ_mc_logsum() calculating wc for journey #%d\n", journey);
	...
	if (Avail[7]) {
		...
		if (dc < -MAX_EXP || dc > MAX_EXP) {
			printf ("\nerror in univ_mc_logsum() calculating dc for journey #%d\n", journey);
	...
	if (Avail[0] || Avail[8]) {
		if (da_tx < -MAX_EXP || da_tx > MAX_EXP) {
			printf ( "\nerror in univ_mc_logsum() calculating da_tx for journey #%d\n", journey);
	...
	if (Avail[1] || Avail[2] || Avail[3]) {
		if (sr < -MAX_EXP || sr > MAX_EXP) {
			printf ( "\nerror in univ_mc_logsum() calculating sr for journey #%d\n", journey);
	...
	if (Avail[4] || Avail[5] || Avail[6] || Avail[7]) {
		if (tr_cr < -MAX_EXP || tr_cr > MAX_EXP) {
			printf ( "\nerror in univ_mc_logsum() calculating tr_cr for journey #%d\n", journey);
